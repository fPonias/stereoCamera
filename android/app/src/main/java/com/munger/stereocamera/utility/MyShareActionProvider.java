...
public class MyShareActionProvider extends ActionProvider {
	...
	private MyActivityChooserModel.OnChooseActivityListener mOnChooseActivityListener;
	...
	public View onCreateActionView() {
		...
		//activityChooserView.setDefaultActionButtonContentDescription("Share With");
	...
	public void onPrepareSubMenu(SubMenu subMenu) {
		...
		if (collapsedActivityCount < expandedActivityCount) {
			...
			SubMenu expandedSubMenu = subMenu.addSubMenu(Menu.NONE, collapsedActivityCount,
					collapsedActivityCount, "See all");
	...
	private class ShareMenuItemOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener
	{
		...
		public boolean onMenuItemClick(MenuItem item)
		{
			...
			dataModel.chooseActivity(itemId, new MyActivityChooserModel.OnChooseActivityResponder() { public void sendIntent(Intent launchIntent)
			{
	...
	private void setActivityChooserPolicyIfNeeded() {
		...
		if (mOnChooseActivityListener == null)
			mOnChooseActivityListener = dataModel.getDefaultListener();
